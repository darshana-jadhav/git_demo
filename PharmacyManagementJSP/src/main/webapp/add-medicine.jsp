       ...
       <div class="container">
            <form action="${pageContext.request.contextPath}/addmedicine" method="post">
             ...
             <div class="mb-6">
                ...
                <div class="mb-3">
                    <input  class="form-control" type="pass" id="pass" name="medicine-quantity"  placeholder="Enter Quantity">
                ...
                <div class="mb-3">
                    <input  class="form-control" type="pass" id="pass" name="medicine-brand"  placeholder="Enter Brand">
                ...
                <div class="mb-1">
                    <input  class="form-control" type="pass" id="pass" name="medicine-price"  placeholder="Enter Price">
                <br>
                </div>
